"""
Django settings for MYOS project.
...
SECRET_KEY = 'd-5hhuucvg)eg%b(8mypnx=uyr338*63nd(_qa3avc+gi5qubw'
...
WSGI_APPLICATION = 'MYOS.wsgi.application'
...
EMAIL_HOST_USER = 'pankajpatil2002@gmail.com' #my gmail username
EMAIL_PORT = 587
